...
- Product version: `1.0.0.1.3`
- Chrome manifest version: `1.0.0.2`
- Expected Git tag after approval: `v1.0.0.1.3`
- License: MIT
- Candidate ZIP SHA-256: `721ed373700fa5796828cce8627108f15807f1c1f4a996e13ef59a838ffd7875`
...
| Upgrade | Install v1.0.0.1.2 data, install v1.0.0.1.3, verify settings/history/session migration | Release operator records pass/fail |
...
runtime row blocks the final release and must be documented before publishing.
